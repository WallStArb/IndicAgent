...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/bg/dev/indicagent/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/bg/dev/indicagent/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/bg/dev/indicagent/.claude/commands/gsd
AGENTS_DIR=/home/bg/dev/indicagent/.claude/agents
```
...
<execution_context>
Surface state file: `/home/bg/dev/indicagent/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/bg/dev/indicagent/.claude/skills/.gsd-profile`
Engine module: `/home/bg/dev/indicagent/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/bg/dev/indicagent/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
