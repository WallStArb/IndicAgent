#!/usr/bin/env python3
"""context_features_writer — Populate context_features table with daily-cadence macro features.
...
Usage:
    INDICAGENT_ENV=production .venv/bin/python production/scripts/context_features_writer.py
    INDICAGENT_ENV=production .venv/bin/python production/scripts/context_features_writer.py --dry-run
"""
