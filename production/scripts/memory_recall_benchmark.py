...
Usage
-----
  python production/scripts/memory_recall_benchmark.py            # fake embed, 1000 calls
  python production/scripts/memory_recall_benchmark.py --n 5000   # 5000 calls
  python production/scripts/memory_recall_benchmark.py --live-embed  # include Ollama latency
  python production/scripts/memory_recall_benchmark.py --seed-only  # seed rows and exit
