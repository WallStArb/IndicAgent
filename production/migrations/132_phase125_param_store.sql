-- Migration 132: Seed Phase 125 APR keys — CIS gate constants, zone entry width gate, VWAP reversion weights.
--
...
('feature.zone_engine.min_zone_width_atr.equity_etf', 'float', '1.5', 0.0, 10.0,
 '[rca_analysis] Phase 126 zone entry width gate for equity ETF instruments. Noise-band analysis. Not a learning target until Phase 126 consumption code ships.'),
('feature.zone_engine.min_zone_width_atr.forex', 'float', '1.0', 0.0, 10.0,
 '[rca_analysis] Phase 126 zone entry width gate for forex instruments. Tighter spread; calibrated lower than futures/equity. Not a learning target until Phase 126 consumption code ships.'),
...
('feature.zone_engine.min_zone_width_atr.equity_etf',   '1.5',   1),
('feature.zone_engine.min_zone_width_atr.forex',        '1.0',   1),
...
(NOW(), 'feature.zone_engine.min_zone_width_atr.equity_etf', 1, '1.5',   'migration_132', 'Phase 125 APR seed: zone entry width gate'),
(NOW(), 'feature.zone_engine.min_zone_width_atr.forex',      1, '1.0',   'migration_132', 'Phase 125 APR seed: zone entry width gate'),
