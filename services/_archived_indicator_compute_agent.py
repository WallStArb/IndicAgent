#!/usr/bin/env python3
"""DEPRECATED: IndicatorComputeAgent 2026-04-01 — superseded by IntelligencePipelineAgent (services/intelligence_pipeline_agent.py) which runs I1-I7 in-process as part of the Phase 57 DAG refactor."""
"""
