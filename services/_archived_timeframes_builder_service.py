#!/usr/bin/env python3
"""DEPRECATED: TimeframeBuilderService 2026-04-01 — superseded by BarAggregatorComputeAgent (services/bar_aggregator_agent.py) which handles 1m→HTF aggregation as a standalone DAG node."""
"""
...
Status: Deprecated ❌ — see services/bar_aggregator_agent.py
"""
