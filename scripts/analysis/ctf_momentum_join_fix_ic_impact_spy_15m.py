"""Todo 243 follow-up, 15m: how much did the CTF join fix (commit 42c69b93) move ctf_momentum's
actual IC at the tf Phase 167's live construction actually trades?
...
Bootstrap block_size=26 matches live `alpha.ic.bootstrap_block_size.15m` (config_state,
confirmed 2026-08-03), not the 1h script's 10 -- same convention the nonlinear_interaction_combiner
replication scripts use per tf.

Usage: .venv/bin/python scripts/analysis/ctf_momentum_join_fix_ic_impact_spy_15m.py
"""
