"""Edge Source Thesis T5 falsification test (non-linear interaction combiner) -- equity/1h,
...
Design, per docs/ideas/measurement-nonlinear-interaction-combiner.md:
  ...
  - BH-FDR corrected across the ~80 per-symbol tests -- added 2026-08-02 (todo 232 cleanup):
    ...
    doc's own T5 bar requires it everywhere, and the flagship number shouldn't be held to a
...
Orchestration lives in `_t5_nonlinear_combiner_shared.py`'s `run_t5_check()`, shared verbatim
