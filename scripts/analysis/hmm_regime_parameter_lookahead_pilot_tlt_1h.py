...
This script runs it, cheaply, on one symbol/tf (TLT/1h, broadening todo 248's SPY/1h pilot to a different asset class) -- no production code changes, no corpus
writes, no full-fix engineering. Two labelings, both fully causal at decode time, differing only
...
Usage: .venv/bin/python scripts/analysis/hmm_regime_parameter_lookahead_pilot_tlt_1h.py
"""
