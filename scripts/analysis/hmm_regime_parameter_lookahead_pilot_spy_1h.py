...
This script runs it, cheaply, on one symbol/tf (SPY/1h) -- no production code changes, no corpus
...
Usage: .venv/bin/python scripts/analysis/hmm_regime_parameter_lookahead_pilot_spy_1h.py
"""
