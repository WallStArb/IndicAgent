...
from scripts.analysis._date_panel import Panel as _DatePanel  # noqa: E402
from scripts.analysis._date_panel import (
    _concat_ranges,  # noqa: E402
    _panel_synchronous_shift_indices,  # noqa: E402
)
from scripts.analysis._date_panel import spearman as _spearman  # noqa: E402
...
# Re-exported: tests/unit/test_alpha_score_residual_panel_sync_shift.py imports these here.
__all__ = ["Panel", "_panel_synchronous_shift_indices"]
...
class Panel(_DatePanel):
    """The shared panel with this diagnostic's pinned family size, block and worker count."""

    def __init__(self, symbol_ids, dates, scores, returns) -> None:
        super().__init__(
            symbol_ids,
            dates,
            scores,
            returns,
            min_rows=_MIN_BARS_PER_SYMBOL,
