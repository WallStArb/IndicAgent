...
**6 tasks — all changes to `production/scripts/historical_backfill.py` only:**
...
6. Run: `python production/scripts/historical_backfill.py --replay-only --clean --workers 8`. Verify [INTEGRITY PASS].
...
- Test file: `tests/unit/scripts/test_historical_backfill.py`
