...
(topdown Open Q4; `docs/ideas/regime-multi-regime-layer.md` Open Question 1). TLT is the
...
- **`docs/ideas/regime-multi-regime-layer.md` Open Question 1:** its recommendation is hereby
