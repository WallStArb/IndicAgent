...
| `instrument_tags.weight` | 410 rows, all `source='human'`, only 7 distinct weight values (re-verified). Calibrator (`docs/ideas/instrument-tag-calibrator.md`, todo 040) unbuilt. | Vestigial column carrying guesses used by live breadth logic. |
