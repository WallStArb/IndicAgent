...
key-files:
  created:
    ...
    - .planning/milestones/v3.1-phases/161-controlled-vocabulary-system/deferred-items.md
  modified:
...
- `.planning/milestones/v3.1-phases/161-controlled-vocabulary-system/deferred-items.md` — logs the pre-existing migration-239 numbering collision (out of scope)
...
- **Duplicate migration number 239 on `main`** (pre-existing, not caused by this plan) — logged in `.planning/milestones/v3.1-phases/161-controlled-vocabulary-system/deferred-items.md` as an out-of-scope discovery per the executor's scope-boundary rule. Both 239-numbered files already applied cleanly; no functional breakage, just a numbering-hygiene gap for a future migration-tooling pass to consider.
