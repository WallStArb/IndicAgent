# Phase 168: Cost-Hurdle-Adjusted Spread Construction (cross_sectional_relative_value Follow-On) - Context
...
- Whether the parity/comparison query lives as a new script (cross_sectional_relative_value-script-style, matching Phase
...
- `docs/research/data-edge-source-thesis.md` — cross_sectional_relative_value section, for the underlying validated result
  this phase's baseline construction rests on

### The prior phase this one extends (do not re-litigate its decisions)
- `.planning/milestones/v3.1-phases/167-cross-sectional-trade-construction/167-CONTEXT.md` — D-01 through
...
- `.planning/milestones/v3.1-phases/167-cross-sectional-trade-construction/167-VALIDATION.md` and
...
- `.planning/STATE.md` — current in-flight `ic_engine` corpus recompute is unrelated to this
  phase (cross_sectional_relative_value/nonlinear_interaction_combiner-style analysis reads `feature_vectors`/`forward_returns` directly, not
