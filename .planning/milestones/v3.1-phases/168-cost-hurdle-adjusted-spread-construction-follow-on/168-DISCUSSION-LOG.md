# Phase 168: Cost-Hurdle-Adjusted Spread Construction (cross_sectional_relative_value Follow-On) - Discussion Log
...
- Whether the before/after comparison lives as a new analysis script (cross_sectional_relative_value-script precedent) or a
