...
- `.planning/milestones/v3.1-phases/172-hmm-regime-volatility-only-redesign/172-CORPUS-RELABEL.md` - full gate
...
- FOUND: .planning/milestones/v3.1-phases/172-hmm-regime-volatility-only-redesign/172-CORPUS-RELABEL.md
- FOUND: .planning/milestones/v3.1-phases/172-hmm-regime-volatility-only-redesign/evidence/172-05-relabel-coverage.json
