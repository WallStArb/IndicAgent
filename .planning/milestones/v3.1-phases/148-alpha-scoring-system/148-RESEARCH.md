...
**What goes wrong:** The schema doc (`docs/plans/archive/2026-06-25-v30-alpha-lifecycle-schema.md`)
...
- `.planning/milestones/v3.1-phases/148-alpha-scoring-system/148-CONTEXT.md` — user decisions D-01 through D-08, canonical refs, reusable assets (read in full)
- `docs/plans/archive/2026-06-25-v30-alpha-lifecycle-schema.md` — schema/APR key design (read in full)
...
- `.planning/milestones/v3.1-phases/143.1-measurement-and-eligibility-integrity-fisher-z-ci-bootstrap-/143.1-08-SHADOW-VALIDATION.md` §6/§7 — exact champion numbers (read in full)
