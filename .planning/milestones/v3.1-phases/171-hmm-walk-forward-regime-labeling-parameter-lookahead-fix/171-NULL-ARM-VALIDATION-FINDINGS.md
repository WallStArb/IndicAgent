...
.venv/bin/python scripts/analysis/hmm_production_regime_axes_null_arm_validation.py \
    --max-workers 20 \
    --results-path .planning/milestones/v3.1-phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-null-arm-validation/null-arm-validation.json
```
