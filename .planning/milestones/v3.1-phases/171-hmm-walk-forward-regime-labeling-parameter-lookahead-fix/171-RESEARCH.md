...
- **Do not issue one corpus-wide `UPDATE feature_vectors SET regime = NULL ...` statement.**
  ...
  (`.planning/milestones/v3.1-phases/151-.../151-07-PLAN.md`).
...
client-43's target symbols as `fetch_complete=true`, (c) `.planning/milestones/v3.1-phases/151-*` shows waves
...
- `.planning/milestones/v3.1-phases/151-feature-primitives-expansion-theory-motivated-interaction-la/151-07-PLAN.md`
...
`.planning/milestones/v3.1-phases/151-*` execution status immediately before planning/execution — everything
