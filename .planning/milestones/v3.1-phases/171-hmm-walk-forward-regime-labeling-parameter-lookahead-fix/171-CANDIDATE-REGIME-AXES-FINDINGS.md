...
.venv/bin/python scripts/analysis/hmm_candidate_regime_axes_identifiability_sweep.py \
    --max-workers 16 \
    --results-path .planning/milestones/v3.1-phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-candidate-regime-axes/sweep-candidate-axes.json

.venv/bin/python scripts/analysis/hmm_candidate_regime_axes_identifiability_sweep.py \
    --axes systematic volume_price --axis-windows 'systematic:120,250;volume_price:120,250' \
    --max-workers 16 \
    --results-path .planning/milestones/v3.1-phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-candidate-regime-axes/sweep-candidate-axes-long-windows.json
```
