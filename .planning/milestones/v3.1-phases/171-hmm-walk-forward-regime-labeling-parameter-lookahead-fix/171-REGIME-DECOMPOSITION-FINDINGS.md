...
.venv/bin/python scripts/analysis/hmm_regime_axis_decomposition_identifiability_sweep.py \
    --max-workers 16 \
    --results-path .planning/milestones/v3.1-phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-regime-decomposition/sweep-axis-decomposition.json
```
