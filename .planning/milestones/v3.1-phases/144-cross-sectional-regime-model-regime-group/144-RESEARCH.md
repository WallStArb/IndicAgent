...
Phase 144 executes `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md` (2687 lines, Tasks
...
- **D-01:** Phase 144 ships exactly `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md`'s
...
- `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md` (2687 lines, read in full) — the
...
- Live PostgreSQL queries (`\d market_regimes`, `\d feature_ic_scores`, `instrument_tags` tag
  ...
  vocabulary coverage.
- `.planning/milestones/v3.1-phases/144-cross-sectional-regime-model-regime-group/144-CONTEXT.md` — locked
