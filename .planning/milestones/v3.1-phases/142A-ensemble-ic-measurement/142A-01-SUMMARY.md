...
- `.planning/milestones/v3.1-phases/142A-ensemble-ic-measurement/deferred-items.md` - 33 pre-existing HMM causal-decode test failures logged, confirmed unrelated to this plan
