...
Closed into the research ledger: the idea lives as a row in `docs/research/construction-verdict-ledger.md` (single list of ideas); todos are for work only. It enters a book as a pre-registered family member once todo 435 wires `feature_vectors` into the research layer.
