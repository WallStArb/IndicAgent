...
Closed: the retry script targets the old 80-symbol universe and the nightly systemd job replaced it. The end-of-run completeness summary moved to todo 387.
