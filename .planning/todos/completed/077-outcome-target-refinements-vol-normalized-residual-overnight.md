...
unblocked today (unlike L3-2's Phase 146 gate) and rides the same corpus re-run 143.1 is already
doing for its Fisher-z CI and sign-symmetric eligibility fixes. L3-2 and L3-4 below remain
deferred to the v3.15/Phase 151 batch as originally scoped.
...
**Gate:** L3-2 needs Phase 146's measured betas. L3-4 is unblocked today but diagnostic-only.
...
wearing relative-value costume. Sequence into the same v3.15 batched rerun as Phase 146 lands.
...
Closed into the research ledger: the idea lives as a row in `docs/research/construction-verdict-ledger.md` (single list of ideas); todos are for work only. It enters a book as a pre-registered family member once todo 435 wires `feature_vectors` into the research layer. Mostly covered already: S1's residualized target and family 2's overnight leg.
