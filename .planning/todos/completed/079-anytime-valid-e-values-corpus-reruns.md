...
Closed: serves a mechanism the adopted evidence framework (E15, `docs/plans/2026-09-24-evidence-framework.md`) replaced: per-feature admission, bootstrap variants E16/E17 superseded, the emission / alpha_events / alpha_frames capital path, frozen legacy verdicts, or cleanup inside dead scripts. A change to confirmation (e-values) would be a methodology-change-ledger entry, not a todo.
