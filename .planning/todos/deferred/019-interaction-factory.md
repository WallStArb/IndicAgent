...
**Concept doc:** `docs/ideas/interaction-factory.md` (refreshed 2026-07-01 — reframed from a service to a candidate-generation strategy, added the evidence-based trigger, fixed statistical gaps)
