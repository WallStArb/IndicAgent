...
ic_engine, IBKR) is open. Phase 177 includes a triage of this whole backlog (on-path / keep /
close-or-park), target under 60 pending.

| Phase | On-path todos |
|---|---|
| 177 Data integrity floor | 395, 376, 390 |
| 178 Recompute throughput bundle | 401, 389, 386, 399, 385 (prange layout), 404, 402 |
| 179 Cross-asset sleeve walk-forward verdict | 393, 248 (causal regime labels at each refit) |
