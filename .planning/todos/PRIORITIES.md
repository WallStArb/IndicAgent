...
| [364](pending/364-nonlinear-combiner-n1-fresh-rerun-post-corpus-changes.md) | New 2026-09-01, from a "did the recompute reopen anything?" check. Confirmed Phase 173/todo 335 don't touch N1 (nonlinear_interaction_combiner) specifically -- different subsystem, equity-only universe. But N1's own verdict is "inconclusive" (not settled), it ran 2026-08-25, and real corpus-integrity fixes have landed since -- cheap re-run worth doing before citing it as unresolved indefinitely. The 4 DEAD pilots + T2 + Phase 167 do NOT need re-running (confirmed independent of anything that changed) -- don't extend this to a blanket "re-run everything" pass. |
