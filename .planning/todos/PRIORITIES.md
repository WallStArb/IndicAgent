...
| [375](pending/375-single-name-only-range-pct-fast-refalsification.md) | New 2026-09-13, out of a council review of the fired personal-scale decision gate. A diagnostic (not a re-falsification) found `range_pct_fast_xs_ls_h5`'s pooled DEAD verdict (β=1.14, R²=0.75) was disproportionately an ETF-subset property — single-name-only shows β=0.91/R²=0.44 and a neutralized intercept more than double the pooled result (10.17bp vs 4.87bp). Does NOT reopen the fired kill criterion (no cost drag/bootstrap/null computed) but is the single highest-leverage open lead the review surfaced — real, verified, cheap to properly falsify (reuses existing panel/machinery, no new data). |
