...
| [179](pending/179-gate166-concurrent-exposure-diagnostic.md) | **CONCLUSIVE as of 2026-07-24** — exhaustive 9-regime × symbol_hmm × 12-historical-episode sweep (2006-2026) found every lead (high_neutral, low_bull×trending_down) either fails its own bootstrap CI or fails to replicate out-of-window. No cell shows real non-circular edge under the OLD (pre-todo-092) regime labels. Directly connects to the 143.1-08 sign-symmetric HOLD verdict and todo 147. Real next step is now a strategic choice (invest in Phase 164/165 features vs. accept no OOS edge on this branch) — should be revisited once todo 092's live recompute lands, since regime labels will change. |
