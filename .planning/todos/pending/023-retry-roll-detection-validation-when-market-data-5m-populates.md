...
5. Restart services:
   ```bash
   echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl restart indicagent-tws indicagent-feature-pipeline indicagent-signal-generator indicagent-signal-lifecycle indicagent-feature-writer
   ```
