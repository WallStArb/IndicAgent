...
key-files:
  created:
    ...
    - .planning/phases/161-controlled-vocabulary-system/deferred-items.md
  modified:
...
- `.planning/phases/161-controlled-vocabulary-system/deferred-items.md` — logs the pre-existing migration-239 numbering collision (out of scope)
