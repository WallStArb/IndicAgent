...
```sql
-- Source: CONTEXT.md D-04, correcting docs/plans/archive/2026-06-25-v30-alpha-lifecycle-schema.md's
...
(lines 122-193 of `docs/plans/archive/2026-06-25-v30-alpha-lifecycle-schema.md`) still governs unchanged.
...
- `docs/plans/archive/2026-06-25-v30-alpha-lifecycle-schema.md` — read in full
