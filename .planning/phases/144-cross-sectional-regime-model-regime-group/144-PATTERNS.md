...
correctly, `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:156-176`). But
...
`vix_z.rank(pct=True, na_option="keep")` (`docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:564`)
...
(`docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:750-858`) is new math with no live
...
(`docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:2354-2456`, `2561-2641`) has no live
...
def _build_symbol_regime_class(
    ...
    return result
```
(Source: `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:1689-1742`, already unit-tested in
...
(`docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:616-750, 2278-2354, 2503-2561`) — RESEARCH.md
...
(`docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:872-1051`, full file read this session) —
...
**Source:** `docs/plans/archive/2026-07-01-cross-sectional-regime-model.md:1689-1742` (`AmbiguousRegimeGroupError`)
