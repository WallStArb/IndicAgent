...
key-decisions:
  ...
  - "The in-sample segment is logged with segment='in_sample_diagnostic' and is never fed into gate1_passes -- it exists solely to make the cross_sectional_relative_value script's full-2006-2026-history published numbers comparable to the OOS verdict."
