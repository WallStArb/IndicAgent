...
- `tests/unit/services/test_ic_engine.py` - 4 new tests: `_assert_prerequisites` positive and
  ...
  volatility labels.
- `.planning/phases/172-hmm-regime-volatility-only-redesign/172-IC-ENGINE-CUTOVER.md` - the
...
- FOUND: .planning/phases/172-hmm-regime-volatility-only-redesign/172-IC-ENGINE-CUTOVER.md
