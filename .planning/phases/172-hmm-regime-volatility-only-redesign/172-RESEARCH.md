...
- `.planning/phases/171-.../171-FINAL-VERDICT.md` (read in full) — the locked design source
- `.planning/phases/171-.../171-06-PLAN.md`, `171-07-PLAN.md` frontmatter (withdrawn rollout
  templates)
