...
<output>
After completion, create `.planning/phases/138-ic-engine-forward-returns/138-04-SUMMARY.md` documenting the regime label distribution per (symbol, tf), the canonical label mapping used, and any (symbol, tf) cells that failed HMM convergence.
</output>
