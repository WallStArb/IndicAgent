...
<output>
After completion, create `.planning/phases/138-ic-engine-forward-returns/138-03-SUMMARY.md` documenting forward_returns row counts per (symbol, tf), completeness fractions per lookahead, the TRAINING_WINDOW_END value used, and confirmation of the causal formula validation.
</output>
