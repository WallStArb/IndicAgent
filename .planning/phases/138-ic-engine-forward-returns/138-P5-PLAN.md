...
<output>
After completion, create `.planning/phases/138-ic-engine-forward-returns/138-05-SUMMARY.md` documenting the test results, the report paths, and a short summary of which features carried the strongest edge (top by IC Sharpe, passing walk-forward), plus the count in the JSON passing_features array.
</output>
