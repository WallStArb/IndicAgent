...
- `docs/plans/2026-07-13-concept-registry-mvp-implementation-plan.md` — the full 7-task
...
- `.planning/phases/144-cross-sectional-regime-model-regime-group-planned/144-CONTEXT.md` — is
