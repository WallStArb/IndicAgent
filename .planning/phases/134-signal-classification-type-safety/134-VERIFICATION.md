...
```
echo '***REDACTED-SUDO-PASSWORD***' | /usr/bin/sudo.ws -S systemctl stop indicagent-intelligence-pipeline
```
...
```
echo '***REDACTED-SUDO-PASSWORD***' | /usr/bin/sudo.ws -S systemctl start indicagent-intelligence-pipeline
```
