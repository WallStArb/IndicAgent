...
| `docs/plans/2026-07-22-phase148-promotion-decision.md` | doc (governance artifact) | — | `docs/plans/SHADOW-REVIEW.md` / `docs/plans/OOS-EVAL-PROTOCOL.md` | role-match (doc conventions, not code) |
