...
key-files:
  created:
    ...
    - .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-seed-stability-pilot.json
    - .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-n-restarts-comparison.json
    - .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-provenance-report.json
  modified: []
...
- FOUND: .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-PILOT-GATE.md
- FOUND: .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-seed-stability-pilot.json
- FOUND: .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-n-restarts-comparison.json
- FOUND: .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/evidence/171-05-provenance-report.json
- FOUND: .planning/phases/171-hmm-walk-forward-regime-labeling-parameter-lookahead-fix/171-05-SUMMARY.md
