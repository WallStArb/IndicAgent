...
- **Phase 182** (Security classification hierarchy, todo 384): EXECUTED 2026-09-25, 7/7 plans; migrations 364 and 365 applied live, 295 instruments classified, coverage audit 0 uncovered, todo 384 closed; /simplify done (654afcead). Still owed: code review (interrupted by the session limit) and goal verification. Deferred items: RSPG stale contract_details name, VIX/VX duplicate rows, a single classification writer when reclassification is built.
