const HIGHLIGHTS = [
  ...
  },
  {
    ...
    desc:
      "The intelligence_features hypertable is the ground truth training dataset. Every bar across every instrument and timeframe writes the full I1–I8 feature vector including JSONB tiers. Signal outcomes JOIN back via (symbol, feature_ts, feature_tf). Nothing is discarded — storage is the cheapest thing owned. Every output is a labeled training sample.",
    accent: "amber",
  },
];
