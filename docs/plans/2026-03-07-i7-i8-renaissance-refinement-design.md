...
| Cleaner P&L attribution | Loses interpretability ("trend_regime" → "factor_3") |
...
Approach 1 (orthogonal decomposition) requires historical outcome data we don't have yet. Approach 3 (regime-aware features) can be implemented immediately and provides the data foundation for Approach 1 later.
