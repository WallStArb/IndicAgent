...
```bash
echo '!123Angelina' | sudo -S -u postgres psql -d indicagent -f production/migrations/016_cis_attribution.sql
```
...
```bash
echo '!123Angelina' | sudo -S -u postgres psql -d indicagent -c "\d signal_ledger" | grep cis_attr
```
