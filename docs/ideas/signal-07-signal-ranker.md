...
(`docs/architecture/i7-setup-confidence-patterns.md`) so `raw_confidence` is a clean intrinsic
...
- `docs/architecture/i7-setup-confidence-patterns.md` — 6 GOOD patterns; `raw_confidence` must be clean before training
