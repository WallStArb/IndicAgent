> **ARCHIVED 2026-07-03.** Superseded by `docs/ideas/canonical-simulator.md` v2.0, rewritten per
...
on IR (see `docs/ideas/edge-source-thesis.md`, breadth section), but multiplying the universe
...
- **One model, one book** — now a foundation invariant, `docs/foundation/principles.md`
  (promoted 2026-07-03 from `docs/ideas/archive/intel-11-dual-system-discrete-vs-portfolio.md`)
