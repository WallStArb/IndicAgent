...
- `docs/ideas/tech-stack.md` — Current stack decisions (Ollama, Redis, TimescaleDB, etc.)
- `docs/ideas/ml-learning-machine.md` — ML Agent stack (full learning machine design)
