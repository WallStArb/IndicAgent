...
- **Primary:** Grok 3 mini Reasoning (OpenRouter/xAI)
  - Cost: $0.30/M input tokens $0.50/M output tokens | MATH-500: 96% | Latency: 0.33s | Throughput: 201 t/s
  **Backup:** DeepSeek: R1 Distill Qwen 7B deepseek/deepseek-r1-distill-qwen-7b 
  - Cost: $0.10/M input tokens $0.20/M output tokens | MATH-500: ~94.5% | Latency: 0.64s | Throughput: 128.4 t/s
- **Backup:** Qwen3 32B (OpenRouter/Lambda) qwen/qwen3-32b
  - Cost: $0.10/M input tokens $0.30/M output tokens| MATH-500: ~93% | Latency: 0.30s | Throughput: 47.02 t/s
- **Tertiary:** Gemini 2.5 Flash-Lite (Google Direct) google/gemini-2.5-flash-lite-preview-06-17
  - Cost: $0.10/M input tokens $0.40/M output tokens | MATH-500: ~84% | Latency: 0.44s | Throughput: 101 t/s
...
- **Backup:** Qwen3 32B (OpenRouter/Multiple providers)
 - Cost: $0.10/M input tokens $0.30/M| MATH-500: 93% | Latency: 0.36s | Throughput: 43 t/s
  **Tertiary:** Google: Gemma 3 27B (OpenRouter/DeepInfa) google/gemma-3-27b-it deepinfra/bf16
- Cost: $0.09/M input tokens $0.17/M output tokens | MATH-500: 89% | Latency: 1.18s | Throughput: 31.98 t/s
