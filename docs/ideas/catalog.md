...
`docs/ideas/archive/`. But `.planning/todos/pending/060-...md`, created 2026-07-05, explicitly asked
...
- **Audited 2026-07-07 — catalog rows removed for docs already physically archived (~50 rows, old
  Clusters 3/4/5/6/7/8). Each confirmed absent from `docs/ideas/` root and present under the same
  filename in `docs/ideas/archive/` before its row was removed — none of these are renames (the
  ...
  - **Genuine duplicate deleted outright (not archived, since a corrected archived copy already
    ...
    without anyone checking it was dead weight. `docs/ideas/archive/alpha-ensemble-lifecycle.md`
