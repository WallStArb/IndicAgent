...
- `docs/ideas/ai-03-evolvable-ai-agents.md` — Long-horizon vision: agents that evolve via Darwinian selection (birth, shadow testing, breeding, promotion, gene bank)
