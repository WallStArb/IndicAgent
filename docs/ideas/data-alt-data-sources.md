...
4. **All three `docs/ideas/` See Also links were broken** (docs moved to `docs/ideas/archive/`);
...
predates: the `StratificationDimension` contract (`docs/ideas/regime-multi-regime-layer.md`,
...
*(Links repaired 2026-07-06, Fable 5 - the three `docs/ideas/` targets had moved to
`docs/ideas/archive/` unnoticed; `catalog.md`'s entry for this doc fixed in the same pass.)*

- `docs/intelligence/intelligence-alphaengine.md` - AlphaEngine concept doc
- `docs/ideas/archive/vision-06-flowagent.md` - FlowAgent vision (flows ingestion)
- `docs/ideas/archive/vision-07-fundagent.md` - FundAgent vision (fundamentals ingestion)
- `docs/ideas/archive/ai-10-qualitative-intelligence-layer.md` - qualitative layer design
- `docs/ideas/regime-multi-regime-layer.md` - `StratificationDimension` contract (home for Kalshi-as-conditioning)
- `docs/ideas/data-edge-source-thesis.md` - counterparty/edge framing that any new data source must answer to
