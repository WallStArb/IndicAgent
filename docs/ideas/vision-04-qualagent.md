...
The existing commercialization vision (in `docs/ideas/commercialization-retail-saas.md`) describes a solid IndicAgent SaaS product. With the expanded product family, the commercial story changes substantially.
