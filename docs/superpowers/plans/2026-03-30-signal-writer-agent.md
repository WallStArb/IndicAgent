...
```bash
echo '!123Angelina' | /usr/bin/sudo.ws -S cp production/systemd/indicagent-signal-writer.service /etc/systemd/system/
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl daemon-reload
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl enable indicagent-signal-writer
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl start indicagent-signal-writer
sleep 3
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl status indicagent-signal-writer --no-pager | grep -E "Active:|Main PID"
```
...
```bash
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl stop indicagent-signal-generator
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl disable indicagent-signal-generator
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl status indicagent-signal-generator --no-pager | grep Active
```
...
```bash
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl restart indicagent-intelligence-pipeline
sleep 10
echo '!123Angelina' | /usr/bin/sudo.ws -S systemctl status indicagent-intelligence-pipeline --no-pager | grep Active
```
