...
- [I1: Technical Indicators](i1-indicators.md) — 17 plugins
- [I3: Market Structure](i3-structure.md) — 3 plugins
- [I4: Context Classification](i4-context.md) — 4 plugins
- [I5: Pattern Detection](i5-patterns.md) — 5 plugins
