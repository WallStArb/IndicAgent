...
does for pipeline-machinery changes, but for hypothesis count instead. As of 2026-09-24,
**16 constructions have been run to a definitive verdict** (count the rows below). Any future
...
(~0.0031 at N=16) for the purpose of deciding whether to act on it, not taken at face value.
