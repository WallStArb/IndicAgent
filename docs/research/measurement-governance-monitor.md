...
once `docs/research/intel-12-stratification-dimension.md` ships — the majority-regime query here
...
production with 61 rows. [Concept Registry](concept-unified-registry.md) is the
...
complete) — see [Concept Registry](concept-unified-registry.md)'s build-trigger section and todo
...
- `docs/research/archive/data-integrity-monitor-design.md`, `docs/research/archive/system-health-monitor-design.md`,
  `docs/research/archive/predictive-decay-detector-design.md` — already correctly marked SUPERSEDED,
...
- `docs/plans/archive/2026-06-27-ensemble-lifecycle-implementation.md` — source of the E2B/E2C
  ...
  dropped.
- `docs/research/archive/feature-vector-lifecycle.md` — original cooldown-based recovery design (superseded
...
- `docs/research/archive/alpha-ensemble-lifecycle.md` — source of the cascade-scenario reasoning and the
  concrete retrain-process spec, both dropped from health-guardian-design.md without restatement.
- `docs/research/feature-registry.md` — the already-production state machine feature lifecycle
  should route through, not duplicate.
- [Concept Registry](concept-unified-registry.md) — the eventual generalization target (D9); its
...
- `.planning/milestones/v3.1-phases/143-feature-lifecycle-routing-merged-with-phase-149b/` —
...
- `docs/research/intel-12-stratification-dimension.md` — regime-conditioning overlap noted above
