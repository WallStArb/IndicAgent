...
| [Edge Source Thesis](data-edge-source-thesis.md) | draft, high | | T1-T9 falsifiable theses on where edge comes from; standing doc, revisit per thesis. **Reorganized 2026-08-03** into Trade Constructions (T1/T3/T4) vs Signal-Extraction Questions (T2/T5/T6-T9); T5's original idea doc archived, fully absorbed inline. **T2 falsified 2026-07-24** (todo 179's 234-cell sweep); **T3 passed 2026-07-26** (cross-sectional decile spread, both scales, cleared shuffled-null guard, strongest evidence-backed candidate on the doc; which tf it should trade at is itself now open, todo 235); **T5 confirmed SMALL not LARGE at 1h/1d** (both re-verified 2026-08-02 under corrected corpus, both hold; 15m OOM-fix in progress, todo 234); **T6-T9 new 2026-08-03** (cointegrated pairs, statistical factor residual, lead-lag structure, adaptive combiner weights), none tested yet |
