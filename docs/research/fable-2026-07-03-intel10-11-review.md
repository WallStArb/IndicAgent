...
**Scope:** `docs/research/intel-10-confluence-detection-persistence-layer.md` (v2.0, 2026-07-01) and `docs/research/intel-11-dual-system-discrete-vs-portfolio.md` (v1.0, 2026-07-01), assessed against the 2026-07-02 topdown/bottomup reviews and the intel-12/13/14/15 docs that came out of them. Both target docs predate that review cycle by one day and were never run through it; this closes the gap.
...
- `docs/research/intel-10-confluence-detection-persistence-layer.md`, `docs/research/intel-11-dual-system-discrete-vs-portfolio.md` — subjects
