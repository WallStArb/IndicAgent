...
**Companion to:** `docs/research/intel-10-confluence-detection-persistence-layer.md`
...
- `docs/research/intel-10-confluence-detection-persistence-layer.md` — DiscreteTrack spec
