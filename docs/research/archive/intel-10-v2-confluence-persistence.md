> **ARCHIVED 2026-07-03.** Superseded by `docs/research/intel-10-confluence-detection-persistence-layer.md`
...
`docs/research/intel-11-dual-system-discrete-vs-portfolio.md` for the companion **PortfolioTrack**
...
`docs/research/concept-governance-registries.md`, which generalizes exactly this pattern
