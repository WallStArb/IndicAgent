...
- **VIL-ready** — Flow state embeds alongside bar state for historical analog retrieval via Vector Intelligence Layer. See `docs/research/analog-engine-01-substrate.md`.
