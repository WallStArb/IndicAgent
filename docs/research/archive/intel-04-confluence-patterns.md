...
**Version:** 1.0
**Status:** SUPERSEDED by `docs/research/intel-10-confluence-detection-persistence-layer.md` (v3.0 successor: confluence as an IC-validated statistical object, not a plugin score). This doc describes the v2.x I6 plugin approach — I5-I7 archived in v3.0.
**Priority:** medium
...
- **Renaissance framing**: `docs/research/renaissance-framing.md`
- **MLAgent learning machine**: `docs/research/ml-learning-machine.md` — similar "Discovery → Scoring → Feedback" loop
