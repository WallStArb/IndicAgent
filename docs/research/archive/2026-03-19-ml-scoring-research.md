...
- [QuantInsti — Regime-Adaptive Trading with HMM and Random Forest](https://blog.quantinsti.com/regime-adaptive-trading-python) — cited in `docs/research/regime-adaptive-trading.md`; walk-forward + stationarity protocol
...
- Internal: `docs/research/regime-adaptive-trading.md`, `docs/research/jim-simons-renaissance-principles.md`, `docs/research/ml-classification-pattern-recognition.md`
