...
| **Momentum acceleration (second derivative)** | Pattern recognition (11); many data points (14) | I1 plugin: `rsi_accel`, `macd_accel`, `roc_accel`, `inflection_flag`. Early exhaustion signal before price/RSI cross. See `docs/research/momentum-acceleration-second-derivative.md`. |
