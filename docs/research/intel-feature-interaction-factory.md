...
**Status:** Evidence trigger CLEARED (2026-07-10), but this doc's specific combinatorial mechanism is superseded by Phase 150's independent decision to build a curated theory-motivated layer instead (see the pilot-result note below) — historical/reference context, not an active implementation spec
