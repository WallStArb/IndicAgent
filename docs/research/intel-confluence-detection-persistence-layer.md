...
written.** Implement the lifecycle in [Concept Registry](concept-unified-registry.md)'s four-table MVP shape
...
- `docs/research/concept-unified-registry.md` — lifecycle MVP, `baseline_metric` shrinkage,
