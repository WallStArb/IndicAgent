...
_DEFAULT_WINDOWS = {"vol_window": 20, "momentum_window": 20, "vol_of_vol_window": 20}
...
def test_obs_matrix_no_nan_or_inf():
    ...
    ts, closes, volumes = _make_prices(500)
    obs, _ = _build_obs_matrix(ts, closes, volumes, **_DEFAULT_WINDOWS)
...
def test_obs_matrix_empty_on_insufficient_data():
    ...
    obs2, valid_ts2 = _build_obs_matrix(ts2, closes2, volumes2, **_DEFAULT_WINDOWS)
