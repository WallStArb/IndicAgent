...
def make_mock_row(
    ...
    return {
        ...
        "i1": json.dumps(i1 or {"rsi_14": 62.5, "atr_14": 8.3}),
        "i3": json.dumps(i3 or {"trend_direction": 1.0}),
        "i4": json.dumps(i4 or {"garch_sigma": 0.0023, "garch_vol_regime": 1}),
        "i5": json.dumps(i5 or {"squeeze_active": 0.0}),
        "smc": json.dumps(smc or {"bos_detected": False}),
        "i6": json.dumps(i6 or {"ctf_score": 0.75}),
    }
