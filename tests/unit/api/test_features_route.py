...
def make_mock_row(
    ...
    return {
        ...
        "pattern_detections": json.dumps(i3 or {"trend_direction": 1.0}),
        "regime_features": json.dumps(i4 or {"garch_sigma": 0.0023, "garch_vol_regime": 1}),
        "confluence_scores": json.dumps(i5 or {"squeeze_active": 0.0}),
