...
def test_result_rejects_non_numeric_score() -> None:
...
def test_result_coerces_non_list_contradicting_assets() -> None:
    out = CorrelationResult(
        coherence_score=0.5,
        confidence=0.5,
        contradicting_assets="VIX",
...
def test_multiplier_formula_semantics() -> None:
    """multiplier = coherence_score x confidence per D-04."""
