...
class TestRSIDivergence:
    def test_bullish_divergence(self):
        ...
        from src.intelligence.patterns.rsi_divergence import RSIDivergencePlugin
...
class TestVolumeDivergence:
    def test_bearish_volume_divergence(self):
        ...
        from src.intelligence.patterns.volume_divergence import VolumeDivergencePlugin
...
class TestConfluence:
    def test_overbought_confluence(self):
        ...
        from src.intelligence.patterns.confluence import ConfluencePlugin
...
class TestRegistration:
    def test_all_patterns_registered(self):
        ...
        from src.intelligence.patterns.bollinger_squeeze import plugin as squeeze
        from src.intelligence.patterns.confluence import plugin as confluence
        from src.intelligence.patterns.rsi_divergence import plugin as rsi_div
        from src.intelligence.patterns.volume_divergence import plugin as vol_div
