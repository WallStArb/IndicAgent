...
class TestFVGFill:
    ...
    def test_confidence_scales_with_open_count(self):
        ...
        plugin = self._plugin()
        feat_low = {"fvg_type": 1, "fvg_open_count": 1.0, "fvg_top": 5010.0, "fvg_bottom": 5000.0, "atr_14": 10.0}
        feat_high = {"fvg_type": 1, "fvg_open_count": 3.0, "fvg_top": 5010.0, "fvg_bottom": 5000.0, "atr_14": 10.0}
...
class TestRegimeTransition:
    ...
    def test_bullish_transition_fires_long(self):
        """cp_probability>0.5, choch_detected=1.0, choch_direction=1, hmm toward trend_up → direction==1."""
        plugin = self._plugin()
        features = {
            "cp_probability": 0.75,
            "choch_detected": 1.0,
    ...
    def test_bearish_transition_fires_short(self):
        """cp_probability>0.5, choch_detected=1.0, choch_direction=-1, hmm toward trend_down → direction==-1."""
        plugin = self._plugin()
        features = {
            "cp_probability": 0.80,
            "choch_detected": 1.0,
