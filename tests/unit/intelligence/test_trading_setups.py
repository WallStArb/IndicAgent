...
class TestHMMGradientContinuity:
    ...
    def test_choch_reversal_continuous_regime_boost(self):
        """CHoCH confidence boost scales with directional HMM probability."""
        ...
        base = {
            "choch_detected": 1.0,
            "choch_direction": 1,  # bullish CHoCH
            "atr_14": 10.0,
        }
    ...
    def test_prev_day_level_test_continuous_regime(self):
        """Fade/continuation confidence scales with regime probability, not binary."""
        ...
        base = {
            "prior_session_high": 5010.0,
            "prior_session_low": 4990.0,
