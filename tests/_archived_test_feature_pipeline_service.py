...
# NOTE: Tests 6-11 (OHLCV batch write path) were removed in Phase 53.1
# when OHLCV writing was moved from FeatureComputeAgent to BarWriterAgent.
# See tests/unit/service_tests/test_bar_writer_agent.py for equivalent tests.
